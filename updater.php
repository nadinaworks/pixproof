...
if ( ! defined( 'ABSPATH' ) || class_exists( 'WPGitHubUpdater' ) || class_exists( 'WP_Pixproof_GitHub_Updater' ) )
	return;
 ...
 */
class WP_Pixproof_GitHub_Updater {
	...
	public function upgrader_post_install( $true, $hook_extra, $result ) {
		...
		$fail  = __( 'The plugin has been updated, but could not be reactivated. Please reactivate it manually.', 'pixproof' );
		$success = __( 'Plugin reactivated successfully.', 'pixproof' );
